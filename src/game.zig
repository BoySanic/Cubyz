...
const common = @import("game_common.zig");
...
pub const Player = struct { // MARK: Player
	...
	pub var id: u32 = 0;
	pub var gamemode: Atomic(common.Gamemode) = .init(.creative);
	...
	pub fn setGamemode(newGamemode: common.Gamemode) void {
	...
	pub fn placeBlock() void {
		if(!main.build_options.headless) {
