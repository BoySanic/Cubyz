...
const mesh_storage = @import("renderer/mesh_storage.zig");
...
const BlockUpdate = mesh_storage.BlockUpdate;
...
pub const Protocols = struct {
    ...
    pub const chunkTransmission = struct {
        ...
        fn receive(_: *Connection, reader: *utils.BinaryReader) !void {
            ...
            mesh_storage.updateChunkMesh(ch);
        }
    ...
    pub const lightMapTransmission = struct {
        ...
        fn receive(_: *Connection, reader: *utils.BinaryReader) !void {
            ...
            mesh_storage.updateLightMap(map);
        }
    ...
    pub const blockEntityUpdate = struct {
        ...
        pub fn sendClientDataUpdateToServer(conn: *Connection, pos: Vec3i) void {
            const mesh = mesh_storage.getMesh(.initFromWorldPos(pos, 1)) orelse return;
            mesh.mutex.lock();
